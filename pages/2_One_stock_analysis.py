...
fig_price_journey.update_layout(xaxis_range = ['2020-01-01',df_selected.select(pl.col('date')).max()],                                   
                                showlegend = False,
                                title = {'x':0.5},
...
fig_price_pct.update_layout(xaxis_range = ['2020-01-01',df_selected2.select(pl.col('date')).max()],                            
                                showlegend = False,
                                title = {'x':0.5},
                                plot_bgcolor = "rgba(0,0,0,0)",
                                xaxis = (dict(showgrid = False)),
